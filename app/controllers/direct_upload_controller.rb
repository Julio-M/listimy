class DirectUploadController < ApplicationController
    ...
    skip_before_action :authorize_freelancer
    ...
    def create
      ...
      def create_blob(blob_args)
        ...
        png_id = SecureRandom.uuid # the name of the file will just be a UUID
        blob.update_attribute(:key, "uploads/#{png_id}") # will put it in the uploads folder
        blob
      end
